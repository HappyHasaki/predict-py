...
def Neural_Network_Graph(input_layer, hidden_layers, output_layer, filename="d:\WorkSpace\\git\\hs300_stock_predict\\data\\demo"):
...
# -------------------------------------------
input_layer = 7  # 输入层的神经元数量
hidden_layers = [5,5,5]  # 隐藏层层数和数量
output_layer = 6  # 输出层神经元数量
# -----------------------------------------------
